...
class PPOModel(LearningModel):
    def __init__(self, brain, architecture, lr=1e-4, epsilon=0.2, beta=1e-3, max_step=5e6,
                 use_curiosity=False, curiosity_strength=0.01, curiosity_enc_size=128, seed=0,):
        """
        ...
        if self.use_curiosity:
            ...
            self._visual_encoding_conf = self.architecture['visual_encoding']
